        ...
        child: Form(
          ...
          child: Column(
            ...
            children: [
              ...
              const SizedBox(height: 15),
              TextFormField(
                decoration: Wapp.globalInput(hint: "Tipo", label: "Tipo del indicador"),
              ...
              SizedBox(
                ...
                child: ElevatedButton(
                  ...
                  onPressed: () async {
                    await controller.newIndicadorController(nombreController.text, puntosController.text, tipoController.text);
                    Get.back();
                  },
                  child: Text(
                    "Guardar Logro",
